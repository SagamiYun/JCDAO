...
async function main() {
    ...
    try {
        ...
        console.log("⛽ 当前 Gas Price:", feeData.gasPrice ? ethers.formatUnits(feeData.gasPrice, "gwei") : "unknown", "gwei");
        ...
        // 输出验证命令
        console.log("\n📌 合约验证命令:");
        console.log(`npx hardhat verify --network polygonAmoy ${membershipAddress} "JCD Membership" "JCDM" "https://jcdao.xyz/metadata/"`);
